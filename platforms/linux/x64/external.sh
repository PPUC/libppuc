...
cp .libs/libserialport.so.0 ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cd ..
...
cp -P build/libyaml-cpp.so.* ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cd ..
