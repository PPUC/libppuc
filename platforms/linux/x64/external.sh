...
./configure
make -j${NUM_PROCS}
cp -a .libs/libserialport.a ${PROJECT_SOURCE_ROOT}/third-party/build-libs/linux/x64/
cp -a .libs/libserialport.so.0 ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cd ..
