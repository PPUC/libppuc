...
cp .libs/libserialport.dylib ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/macos/x64/
cd ..
...
cp -P build/libyaml-cpp*.dylib ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/macos/x64/
cd ..
