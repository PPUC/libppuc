...
if [ -f "${PROJECT_SOURCE_ROOT}/third-party/include/libserialport.h" ] &&
   [ -f "${PROJECT_SOURCE_ROOT}/third-party/build-libs/macos/x64/libserialport.a" ] &&
   [ -f "${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/macos/x64/libserialport.dylib" ]; then
...
if [ -d "${PROJECT_SOURCE_ROOT}/third-party/include/yaml-cpp" ] &&
   ls "${PROJECT_SOURCE_ROOT}"/third-party/runtime-libs/macos/x64/libyaml-cpp*.dylib >/dev/null 2>&1; then
