...
make -j${NUM_PROCS}
cp -a .libs/libserialport.a ${PROJECT_SOURCE_ROOT}/third-party/build-libs/macos/arm64/
cp -a .libs/libserialport.dylib ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/macos/arm64/
cd ..
